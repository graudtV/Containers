...
//interface functions
#define listPushFront(plist, pdata) _Generic((plist), List_ *: _listPushFront)(plist, pdata)
#define listPopFront(plist) _Generic((plist), List_ *: _listPopFront)(plist)
#define listFront(plist) _Generic((plist), List_ *: _listFront)(plist) //Возвращает первый элемент
